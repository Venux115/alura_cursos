...
list_andamento = [
    {
        "id": 1,
        "titulo": "JavaScript: conhecendo o Browser e padrões de projeto",
        "link": "https://cursos.alura.com.br/course/javascript-es6-orientacao-a-objetos-parte-1",
        "icone": "https://www.alura.com.br/assets/api/cursos/javascript-es6-orientacao-a-objetos-parte-1.svg"
    },
    {
        "id": 2,
        "titulo": "Curso de JavaScript: objetos",
        "link": "https://cursos.alura.com.br/course/javascript-objetos",
        "icone": "https://www.alura.com.br/assets/api/cursos/javascript-objetos.svg"
    }
]
...
list_projetos = [
    {
        "id": 1,
        "tipo": "JavaScript",
        "link-hospedagem": "https://cronometro-neon.vercel.app",
...
@app.get("/concluidos")
def concluidos():
    return list_concluidos

@app.get("/em-andamento")
def andamento():
